...
class _EditProductPageState extends State<EditProductPage> {
  ...
  late DateTime _certificationExpiry;
  ...
  void initState() {
    ...
    _certificationController = TextEditingController(text: widget.product.certification);
    _certificationNumberController = TextEditingController(text: widget.product.certificationNumber);
    _priceController = TextEditingController(text: widget.product.price.toString());
    _certificationExpiry = widget.product.certificationExpiry;
